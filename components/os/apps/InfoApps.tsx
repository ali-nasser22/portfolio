            ...
            <div className="bevel-in-deep p-3">
                ...
                <div className="space-y-2">
                    ...
                    <ul className="list-disc pl-5 space-y-1 leading-relaxed">
                        <li>Designed and implemented RESTful APIs for seamless integration with the mobile development
                            team.
                        </li>
                ...
                <div className="mt-4">
                    ...
                    <div className="space-y-1">
                        <div><span className="text-[var(--color-bevel-dark)]">Frameworks:</span> Spring Boot, Laravel,
                            React, Next.js, Node.js, Express.js, Nest.js
                        </div>
                        <div><span className="text-[var(--color-bevel-dark)]">Languages :</span> Java, C, PHP,
                            JavaScript, TypeScript, HTML, CSS
                        </div>
                        <div><span className="text-[var(--color-bevel-dark)]">Databases :</span> PostgreSQL, MySQL,
                            MongoDB
                        </div>
                        <div><span className="text-[var(--color-bevel-dark)]">Certs     :</span> CCNA1, CCNA2, Network
                            Security (Cisco)
                        </div>
                        <div><span className="text-[var(--color-bevel-dark)]">Languages :</span> Arabic (native),
...
const links = [
    ...
    {name: "LinkedIn", url: "https://www.linkedin.com/in/ali-nasser-213b87281/", glyph: "💼"},
    {name: "Portfolio / Blog", url: "https://blog.alinasser.dev", glyph: "📰"},
];
