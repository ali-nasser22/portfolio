...
import {NetworkApp, ProjectsApp, ResumeApp, WorkHistoryApp} from "./apps/InfoApps";
...
function DesktopInner() {
    ...
    if (shutdown) {
        return (
            <div
                className="fixed inset-0 bg-black flex items-center justify-center text-[#e0e0e0] font-mono text-base sm:text-lg z-[20000]">
    ...
    return (
        <div className="relative w-full h-full overflow-hidden crt">
            ...
            <div className="absolute bottom-12 right-4 text-right pointer-events-none select-none">
                ...
                <div className="font-bold text-2xl text-white/15 leading-none mt-1">Ali<span
                    className="text-[var(--accent-teal)]/40">OS</span> 95
                </div>
            </div>
